        ...
        try:
            ...
            if existing_product:
                if existing_product.is_deleted:
                    ...
                    # Show a warning if an active product already exists
                    messages.warning(request, "A product with this name or slug already exists.")
                    return redirect("addproduct")

            # If no existing product, check if the form is valid
            if form.is_valid():
                print("Form is valid")
            ...
            # Handle integrity errors here, e.g., unique constraint violations
            messages.warning(request, "Please select a valid category or resolve other conflicts.")
            return redirect("addproduct")
...
def edit_product(request, pk):
    ...
    context = {"form": form, "imgform": imgform, "existing_images": existing_images}
...
def soft_delete_product(request, pk):
    ...
    try:
        ...
        product.slug += product.product_name + "_DELETED"
